...
----#Changing birthdate to date format and updating table----------------
...
----#Changing Hire_date to date format and updating table----------------
...
----#Changing termdate to date format and updating table----------------
...
----#Adding new column 'age' and updating column with values from age----------------
alter table hr
add column age int;
...
select race,count(*) as race_cnt from hr
where age>=18 and termdate='0000-00-00'
group by race
...
when age>=55 and age<=68 then '55-68'
else '65+'
...
select location,count(*) as location_cnt from hr
where age>=18 and termdate='0000-00-00'
group by location;
...
round((hires-termination)/hires*100,2) as net_change_pct
from (
